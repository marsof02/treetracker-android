# Task 25 — Split monolithic TreeTrackerDAO into entity-specific DAOs (#1235)

Branches: `refactor/split-tree-tracker-dao`, `chore/treetracker-dao-split-repos`, `refactor/dao-split-cleanup` · PRs #1303, #1318, #1319
