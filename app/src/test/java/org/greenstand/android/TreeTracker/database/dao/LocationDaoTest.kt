...
class LocationDaoTest {
    ...
    fun `insert Location Entity, returns valid with non null data `() =
        runTest {
            ...
            locationDao.insertLocationData(newLocation)
            val getLocationEntity = locationDao.getLocationData()
